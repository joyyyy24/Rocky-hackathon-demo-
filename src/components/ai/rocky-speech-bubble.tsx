...
export function RockySpeechBubble({
  ...
  return (
    ...
    >
      <div
        className="absolute right-[16%] top-[30%] w-[min(360px,88vw)] origin-bottom-right animate-[bubble-pop_220ms_ease-out] rounded-[26px] border-[3px] border-slate-800 bg-white px-4 py-4 text-slate-900 shadow-[0_12px_28px_rgba(15,23,42,0.35)]"
      ...
      >
        ...
        <div className="absolute -bottom-4 right-16 h-0 w-0 border-l-[14px] border-r-[14px] border-t-[18px] border-l-transparent border-r-transparent border-t-slate-800" />
        <div className="absolute -bottom-3 right-[67px] h-0 w-0 border-l-[11px] border-r-[11px] border-t-[14px] border-l-transparent border-r-transparent border-t-white" />
      </div>
    </div>
  );
}
